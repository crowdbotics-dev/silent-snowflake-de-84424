"""
Django settings for silent_snowflake_de_84424 project.
...
ROOT_URLCONF = 'silent_snowflake_de_84424.urls'
...
WSGI_APPLICATION = 'silent_snowflake_de_84424.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_snowflake_de_84424 API",
    "DESCRIPTION": "API documentation for silent_snowflake_de_84424 App",
    "VERSION": "v1",
}
